...
hook global WinSetOption filetype=(javascript|typescriptreact) %{
...
hook -group typescriptreact-highlight global WinSetOption filetype=typescriptreact %{
    add-highlighter window/typescriptreact ref typescriptreact
...
# Aliases
# ‾‾‾‾‾‾‾
provide-module typescriptreact %{ require-module javascript }
